...
Two NOAA ERI pre/post image pairs with ViPDE damage assessment results from **Potero Canyon** and **Marquez Knolls** in Pacific Palisades, Los Angeles, CA 90272. For an **interactive demo** with **slider comparison** and **community switching**, see the [**ViPDE project page**](https://feizhao19.github.io/#project-building-damage).
